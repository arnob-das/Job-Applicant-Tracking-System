...
INSERT INTO JOBS (JobTitle, dateposted, company, salary, position, postedBy, jobStatus)
VALUES
    ('Software Engineer', '2023-01-01 12:00:00', 'ABC Tech', 80000, 'Senior Developer', 'jobadvertiser1@example.com', 'open'),
    ('Marketing Specialist', '2023-01-02 10:30:00', 'XYZ Corp', 60000, 'Marketing Manager', 'jobadvertiser2@example.com','open');
